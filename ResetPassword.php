...
<head>
    ...
    <title>Tender - Reset Password</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" id="ResetPasswordForm" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="email"  name="email" value="<?php echo $_GET['key']; ?>">
                                        ...
                                        <button class="btn btn-danger btn-user btn-block"  id="LoadingBtn" disabled>
...
$(document).ready(function() {
    $('#ResetPasswordForm').validate({
      submitHandler: function(form) {
        ...
        data.append('method', 'ResetPassword');
