...
<head>
    ...
    <link href="plugins/icons/bootstrap-icons.css" rel="stylesheet" type="text/css">
                  ...
                  <div class="modal-dialog  modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-center">
                        ...
                        <div id="">
                            <img src="" id="imagepreview" style="max-width: 700px; max-height: 600px" >
                        </div>
                      </div>
                  ...
                  <div class="modal-dialog  modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-center">
                        <div class="d-none " id="ForDescription"> Description : <span id="challan_description"></span> </div>
                        <div id="LoadNewImage">
                            <img src="" id="imagepreviewNew" style="max-width: 700px; max-height: 600px"  >
                        </div>
